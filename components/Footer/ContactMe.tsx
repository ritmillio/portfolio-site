          ...
          <div ref={divRef} className='container mx-auto flex flex-col items-center px-4 md:px-6 max-w-3xl min-h-[40vh] md:min-h-[50vh]'>
            ...
            <CopyToClipboard onCopy={() => isCopied(true)} text="me@zoltanfodor.dev">
              <div className='relative'>
                <p className='py-4 md:pt-6 text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold dark:hover:text-happyhues_4-background-button hover:text-red-700'>me(at)zoltanfodor.dev
                </p>
                { value === true ?
                  <>
