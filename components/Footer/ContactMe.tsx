        ...
        <> 
          <div ref={divRef} className='container mx-auto flex flex-col items-center px-4 md:px-6 max-w-3xl min-h-[40vh] md:min-h-[50vh]'>
            <h2 className='py-3 md:py-5 uppercase text-justify text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-relaxed'>
              Want to reach out about a <span className='dark:text-happyhues_4-background-button text-red-700'>project</span>, <span className='dark:text-happyhues_11-background-button text-purple-800'>collobration</span> or just want to say friendly
              <span className='pl-6 sm:pl-8 md:pl-12 dark:text-pink-500 text-yellow-500'>h</span><span className='dark:text-green-600 text-blue-300'>e</span><span className='dark:text-purple-700 text-pink-500'>l</span><span className='dark:text-blue-400 text-green-500'>l</span><span className='dark:text-orange-600 text-orange-400'>o</span>
              &nbsp;?
            </h2>
