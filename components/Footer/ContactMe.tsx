        ...
        <> 
          <div className='container mx-auto flex flex-col items-center px-4 md:px-6 max-w-3xl min-h-[40vh] md:min-h-[50vh]'>
            <h2 className='py-3 md:py-5 uppercase text-justify text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-relaxed'>
              ...
              <span className='pl-6 sm:pl-8 md:pl-12 dark:text-pink-500 text-yellow-500 text-[48px] sm:text-[68px] md:text-[78px] lg:text-[88px]'>h</span><span className='dark:text-green-600 text-blue-300'>e</span><span className='dark:text-purple-700 text-pink-500 text-[42px] sm:text-[48px] md:text-[55px] lg:text-[64px]'>l</span><span className='dark:text-blue-400 text-green-500'>l</span><span className='text-[56px] sm:text-[74px] md:text-[84px] lg:text-[94px] dark:text-orange-600 text-orange-400'>o</span>
              &nbsp;?
            </h2>
      
            <CopyToClipboard onCopy={() => isCopied(true)} text="me@zoltanfodor.dev">
              <div className='relative'>
                <p ref={parRef} className='py-4 md:pt-6 text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold dark:hover:text-happyhues_4-background-button hover:text-red-700'>me(at)zoltanfodor.dev
                </p>
                { value === true ?
                  <>
