...
const Cookies: React.FC = () => {
  ...
  return (
    <div className="gdpr-consent-panel fixed flex flex-col right-[8px] bottom-[8px] w-[calc(100%-16px)] lg:w-[443px] p-[14px] lg:max-w-[90%] rounded-[4px] bg-dust z-[100] border border-black">
      <div className="flex flex-row space-between mb-[10px]">
        <div className="grow h6">Cookies</div>
        <button
          className="appearance-none w-[24px] h-[24px] rounded-full flex items-center justify-center border-[2px] border-black cursor-pointer"
      ...
      <div className="flex flex-col items-start">
        <div className="xs-paragraph mb-[10px]">
          We use cookies to give you a great user experience on our website. To
          learn more, read our
          <a className="underline underline-offset-1" href="/cookie-policy">
            Cookie Policy
          </a>
          or manage your settings at
          <button className="underline underline-offset-1 appearance-none">
            Cookie Preferences
          </button>
          .
        </div>
      ...
      <div className="flex">
        <button className="rounded-[30px] border-black border-[2px] l-upper px-[10px] leading-none pt-[3px] hover:bg-neon hover:border-neon transition-all duration-300 ease-in-out">
          accept
        </button>
      </div>
    </div>
